...
def brightness(x: ndarray, y: ndarray):
    """
...
def elastic(x: ndarray, y: ndarray, sigma):
    """
...
def rotation(x: ndarray, y: ndarray):
    """
...
def combine_aug(x: ndarray, y: ndarray):
    """
...
def binary_combine_aug(x: ndarray, y: ndarray):
    """
